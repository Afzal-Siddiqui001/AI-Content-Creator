<ul class="tt-side-nav">
            ...
            <div class="collapse {{ areActiveRoutes($subscriptionActiveRoutes, 'show') }}" id="subscription">
                <ul class="side-nav-second-level">
                    ...
                    {{-- @can('subscriptions_settings')
                        <li class="{{ areActiveRoutes(['subscriptions.settings.index'], 'tt-menu-item-active') }}">
                            <a href="{{ route('subscriptions.settings.index') }}"
                                class="{{ areActiveRoutes(['subscriptions.settings.index']) }}">{{ localize('Subscription Packages') }}</a>
                        </li>
                    @endcan --}}
                </ul>
            </div>
    ...
    @canany(['ai_chat', 'chat.experts', 'templates', 'speech_to_text', 'generate_images', 'generate_code',
        ...
        @if (getSetting('enable_ai_chat') != '0')
            @can('ai_chat')
                <li
                    class="side-nav-item nav-item {{ areActiveRoutes(['chat.index', 'chat.experts', 'chat.createExpert'], 'tt-menu-item-active') }}">
        ...
        @if (getSetting('enable_ai_images') != '0')
            ...
            <li class="side-nav-item nav-item {{ areActiveRoutes($imagesActiveRoutes, 'tt-menu-item-active') }}">
                <a data-bs-toggle="collapse" href="#generateImages"
                    ...
                    <span class="tt-nav-link-text">{{ localize('Generate Image') }}</span>
                </a>
                    ...
                    <ul class="side-nav-second-level">
                        @can('generate_images')
                            <li class="{{ areActiveRoutes(['images.index'], 'tt-menu-item-active') }}">
                                <a href="{{ route('images.index') }}">{{ localize('AI Images') }}</a>
                            </li>
