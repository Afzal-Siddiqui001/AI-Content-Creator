                    ...
                    @if ($user->user_type == 'customer')
                        <li class="nav-item me-2">
                            <a href="{{ route('subscriptions.index') }}"
                                ...
                                @else
                                    {{ optional(activePackageHistory())->subscriptionPackage->title }}/{{ optional(activePackageHistory())->subscriptionPackage->package_type == 'starter' ? localize('Monthly') : optional(activePackageHistory())->subscriptionPackage->package_type }}
                                @endif
                            </a>
                        </li>
                    @endif
