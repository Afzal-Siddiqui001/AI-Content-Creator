                        ...
                        @if (checkLanguage($lang_key))
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="feature_image_2_title"
                                        ...
                                        <input type="text" id="feature_image_2_title" name="feature_image_2_title"
                                            class="form-control" value="{{ getSetting('feature_image_2_title') }}">
                                    </div>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="feature_image_3_title"
                                            class="form-label">{{ localize('Title') }}</label>
                                        ...
                                        <input type="text" id="feature_image_3_title" name="feature_image_3_title"
                                            class="form-control" value="{{ getSetting('feature_image_3_title') }}">
                                    </div>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="feature_image_4_title"
                                            class="form-label">{{ localize('Title') }}</label>
                                        ...
                                        <input type="text" id="feature_image_4_title" name="feature_image_4_title"
                                            class="form-control" value="{{ getSetting('feature_image_4_title') }}">
                                    </div>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="feature_image_5_title"
                                            class="form-label">{{ localize('Title') }}</label>
                                        ...
                                        <input type="text" id="feature_image_5_title" name="feature_image_5_title"
                                            class="form-control" value="{{ getSetting('feature_image_5_title') }}">
                                    </div>
