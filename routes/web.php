...
use App\Http\Controllers\Backend\Payments\Molile\MercadopagoPaymentController;
...
Route::group(['prefix' => ''], function () {
    ...
    # midtrans
    Route::get('/midtrans/callback', [MercadopagoPaymentController::class, 'callback'])->name('midtrans.callback');
});
