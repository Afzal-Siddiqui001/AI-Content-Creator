        ...
        Route::group(
            ...
            function () {
                ...
                Route::group(['prefix' => 'subscriptions', 'middleware' => ['auth']], function () {
                    ...
                    Route::get('/delete/{id}', [SubscriptionsController::class, 'delete'])->name('subscriptions.delete');
                ...
                Route::group(['prefix' => 'customers', 'middleware' => 'admin'], function () {
                    ...
                    Route::get('/assign-package/{id}', [CustomersController::class, 'assignPackage'])->name('admin.customers.assignPackage')->middleware('demo');
